...
export default function Coder() {
  ...
  const runCode = async () => {
    ...
    switch (language) {
      case 'python':
        apiUrl = 'http://localhost:5000/run-python';
        break;
      case 'java':
        apiUrl = 'http://localhost:5000/run-java';
        break;
      case 'javascript':
        apiUrl = 'http://localhost:5000/run-javascript';
        break;
      default:
        return;
    }
    ...
    try {
      ...
      setOutput(response.data.output); // Adjust based on actual response structure
    } catch (error) {
